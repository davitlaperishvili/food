...
<div class="sqema">
	...
	<div class="main_wrap trans-all-4">
		...
		<main class="widget medium">
			<section class="top_tools">
				<div class="top_button_search">
					<div class="add">
						<a href="#" title="ახლის დამატება">
							<em data-feather="plus"></em>
							<span>ახლის დამატება</span>
						</a>
					</div>
					<div class="search trans-no">
						<form action="search.php" autocomplete="off">
							<div class="search_form_item">
								<label for="form1">დასახელება:</label>
								<input type="search" id="form1">
							</div>
							<div class="search_form_item">
								<label for="form2">სად:</label>
								<select id="form2" class="selectori" data-placeholder="აირჩიეთ">
									<option></option>
									<option>იუზერში</option>
									<option>სახელით</option>
									<option>გვარით</option>
									<option>id-ით</option>
									<option>სახელით</option>
								</select>
							</div>
							<div class="search_form_item">
								<label for="form3">ჯგუფი:</label>
								<select id="form3" class="selectori" data-placeholder="აირჩიეთ">
									<option></option>
									<option>Administrator</option>
									<option>User</option>
								</select>
							</div>
							<div class="search_form_item search_form_submit">
								<button class="gilaki">ძიება</button>
							</div>
							<!-- <div class="advanced_search_toggle">
								<a href="javascript:void(0);" title="გაფართოებული ძიება">
									<em data-feather="settings"></em>
								</a>
							</div> -->
						</form>
						...
						<li>
							...
							<div class="title_links">
								<div class="menu_title">
									<a href="#" title="სიის ელემენტი">სიის ელემენტი</a>
								</div>
								<div class="menu_links">
									<ul>
										<li class="copy_link">
											<a href="#" title="ბმულის კოპირება" class="link">
												<em data-feather="link"></em>
												<input type="text" value="home.php">
											</a>
										</li>
										<li class="visible">
											<a href="#" title="გამოჩენილი">
												<em data-feather="check"></em>
											</a>
										</li>
										<li class="disabled">
											<a href="#" title="დამალული">
												<em data-feather="eye-off"></em>
											</a>
										</li>
										<li class="edit">
											<a href="#" title="რედაქტირება">

	...
	<div class="main_wrap trans-all-4">
		...
		<main class="widget medium">
			<section class="content_wrap">
				<div class="logs trans-all-4">
					<div class="logs_title">
						<h3>მონაცემები თარიღისთვის: 15 დეკემბერი, 2018</h3>
						<div class="calendar">
							<a href="javascript:void(0);" title="კალენდარი">
								<em data-feather="calendar"></em>
							</a>
						</div>
					</div>
					<div class="logs_filter">
						<form action="logs.php" autocomplete="off">
							<div class="form_double">
								<div class="form_item checkers_item">
									<select class="selectori" data-placeholder="ყველა მოქმედება">
										<option></option>
										<option>დამატება</option>
										<option>დერაქტირება</option>
										<option>წაშლა</option>
									</select>
								</div>
								<div class="form_item found">მოიძებნა <span>445</span> ჩანაწერი</div>
							</div>
						</form>
					</div>
					<div class="table_container">
						<div class="table_wrap">
							<div class="table_head">
								...
								<div>სახელი</div>
								<div>მოქმედება</div>
								<div class="center">ბმული</div>
								<div class="center">მომხ. ID</div>
								<div>IP მისამართი</div>
							</div>
							<div class="table_row">
								<div>12:24:13</div>
								<div>ლიანა დავთიანი</div>
								<div>კონტრაქტები » რედაქტირება</div>
								<div class="center">
									<a href="#" class="ბმული" target="_blank">
										<em data-feather="link"></em>
									</a>
								</div>
								<div class="center">6</div>
								<div>188.129.255.91</div>
							</div>
							<div class="table_row">
								<div>12:24:13</div>
								<div>ლიანა დავთიანი</div>
